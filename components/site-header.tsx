      ...
      <div className="container flex h-16 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm">
          ...
          <Link
            ...
            className={cn(
              "transition-colors hover:text-primary flex items-center gap-1",
              pathname.startsWith("/courses") ? "font-medium text-foreground" : "text-muted-foreground",
            )}
          >
          ...
          <Link
            ...
            className={cn(
              "transition-colors hover:text-primary flex items-center gap-1",
              pathname.startsWith("/forum") ? "font-medium text-foreground" : "text-muted-foreground",
            )}
          >
