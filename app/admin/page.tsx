...
export default function AdminDashboard() {
  ...
  const fetchAdminStats = async () => {
    ...
    try {
      ...
      const [databaseData, healthData, onlineUsersData] = await Promise.all([
  ...
  return (
    <div className="mx-auto max-w-[980px] px-6 py-3 sm:py-6 space-y-4 sm:space-y-6 overflow-hidden">
        ...
        <div className="p-3 sm:px-6 sm:py-4">
          <div className="space-y-2 sm:space-y-0 sm:flex sm:items-center sm:justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-sm sm:text-base sm:font-semibold">
                Quick Actions
              </span>
            </div>
            ...
            <div className="flex flex-row gap-1 sm:gap-3">
              <Button
                ...
                variant="ghost"
                size="sm"
                className="h-8 sm:h-9 flex-1 sm:flex-none justify-center px-1 py-1 sm:px-3 sm:py-2 hover:bg-blue-50 hover:text-blue-700 transition-colors"
              >
                <Link
                  href="/admin/users"
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                className="h-8 sm:h-9 flex-1 sm:flex-none justify-center px-1 py-1 sm:px-3 sm:py-2 hover:bg-green-50 hover:text-green-700 transition-colors"
              >
                <Link
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                className="h-8 sm:h-9 flex-1 sm:flex-none justify-center px-1 py-1 sm:px-3 sm:py-2 hover:bg-pink-50 hover:text-pink-700 transition-colors"
              >
                <Link
                  href="/admin/feedback"
                  className="flex items-center gap-1 sm:gap-2"
            ...
            <Card className="hover:shadow-md transition-shadow">
              <CardContent className="px-3 pt-4 pb-2 sm:px-4 sm:pt-5 sm:pb-3">
                <div className="flex flex-col space-y-1.5">
                  ...
                  <div className="text-lg sm:text-2xl font-bold tracking-tight">
                    {stats.database.tables.course_planner?.toLocaleString() ||
                      0}
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="hover:shadow-md transition-shadow">
              <CardContent className="px-3 pt-4 pb-2 sm:px-4 sm:pt-5 sm:pb-3">
                <div className="flex flex-col space-y-1.5">
                  ...
                  <div className="text-lg sm:text-2xl font-bold tracking-tight">
                    {stats.database.tables.course_schedules?.toLocaleString() ||
                      0}
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="hover:shadow-md transition-shadow">
              <CardContent className="px-3 pt-4 pb-2 sm:px-4 sm:pt-5 sm:pb-3">
                <div className="flex flex-col space-y-1.5">
                  ...
                  <div className="text-lg sm:text-2xl font-bold tracking-tight">
                    {stats.database.tables.review_replies?.toLocaleString() ||
                      0}
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span>Status</span>
                    {getStatusBadge(stats.health.services.database.status)}
                  </div>
                  <div className="flex items-center justify-between">
                    <span>Response Time</span>
                    <span className="text-sm">
                      {stats.health.services.database.responseTime}
                      ms
                    </span>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span>Status</span>
                    {getStatusBadge(stats.health.services.api.status)}
                  </div>
                  <div className="flex items-center justify-between">
                    <span>Response Time</span>
                    <span className="text-sm">
                      {stats.health.services.api.responseTime}
                      ms
                    </span>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span>Status</span>
                    {getStatusBadge(stats.health.services.auth.status)}
                  </div>
                  <div className="flex items-center justify-between">
                    <span>Response Time</span>
                    <span className="text-sm">
                      {stats.health.services.auth.responseTime}
                      ms
                    </span>
                  </div>
                </div>
