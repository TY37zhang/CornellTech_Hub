                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                <span>Status</span>
                                {getStatusBadge(healthData?.services?.database?.status || 'unknown')}
                            </div>
                            <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm text-muted-foreground">
                                    {healthData?.services?.api?.lastChecked 
                                        ? new Date(healthData.services.api.lastChecked).toLocaleTimeString()
                                        : 'Never'
                                    }
                                </span>
                            </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                <span>Status</span>
                                {getStatusBadge(healthData?.services?.auth?.status || 'unknown')}
                            </div>
                            <div className="flex items-center justify-between">
                                <span>Response Time</span>
                                <span className="text-sm">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm text-muted-foreground">
                                    {healthData?.services?.auth?.lastChecked 
                                        ? new Date(healthData.services.auth.lastChecked).toLocaleTimeString()
                                        : 'Never'
                                    }
                                </span>
                            </div>
