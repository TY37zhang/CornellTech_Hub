        ...
        return (
            <div className="mt-4 p-4 bg-muted/50 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                    <div>
                        <span className="font-medium">{getRequirementDisplayName(sourceRequirement)}:</span>{" "}
                        {fromCredits.netCredits} cr → {fromCredits.netCredits - transferAmount} cr
                    </div>
                    <div>
                        <span className="font-medium">{getRequirementDisplayName(toCategory)}:</span>{" "}
                        {toCredits.netCredits} cr → {toCredits.netCredits + transferAmount} cr
                    </div>
                </div>
            </div>
        );
