        ...
        <div className="space-y-4">
          ...
          {!collapsed && (
            <div className="text-sm text-muted-foreground">
              No credit transfers have been created yet. To create a transfer,
              hover over any requirement section above and click the transfer
              icon (⇄) that appears next to the credit count.
            </div>
          )}
        </div>
      </Card>
    ...
    <Card className="p-6 w-full overflow-hidden">
      <div className="space-y-4">
        ...
        {!collapsed && (
          <>
            <div className="text-sm text-muted-foreground">
              Manage your credit transfers between requirements. These
              adjustments are reflected in your credit calculations.
            </div>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            ...
                            transfer? This will remove {transfer.amount} credit
