            ...
            try {
                ...
                if (isDemoMode) {
                    ...
                    if (savedDemoData) {
                        ...
                        setDeductedCategory(
                            detectedCategory || "ConcentrationCore"
                        ); // Fallback to ConcentrationCore if not found
                ...
                if (techieReq) {
                    ...
                    if (techieReq.selected_course_id) {
                        ...
                        console.log(
                            "Techie 5901 requirement found without anchor course"
                        );
                    }
                }
            } catch (error) {
    ...
    const saveDemoData = () => {
        if (isDemoMode) {
            const demoData = {
                ...
                tookTechie5901,
                selectedAnchorCourse: tookTechie5901
    ...
    const saveEthicsRequirement = async (
        ...
        try {
            ...
            const requestBody = {
                ...
                deductedFromCategory: hasEthicsCourse
                    ? deductFromCategory
                    : null,
                        ...
                        >
                            <DialogTrigger asChild>
                                <Button
                                    ...
                                    className="h-8 w-8 p-0 hover:bg-purple-50 hover:border-purple-300 hover:text-purple-700 transition-colors"
                            ...
                            <DialogContent className="sm:max-w-md">
                                <DialogHeader>
                                    ...
                                    <DialogDescription className="text-purple-600">
                                        Move credits from one requirement to
                                        another. This is useful for courses that
                                        can count towards multiple requirements.
                                    </DialogDescription>
                                </DialogHeader>
                    ...
                    <div className="mt-3">
                        <div className="space-y-3">
                            {creditTransfers.map((transfer) => (
                                <div
                                    key={transfer.id}
                                    className="group relative p-4 border border-border/60 rounded-xl bg-gradient-to-r from-purple-50/50 to-blue-50/50 hover:from-purple-50/80 hover:to-blue-50/80 transition-all duration-200 hover:shadow-sm hover:border-border"
                                >
                                    <div className="flex items-center justify-between gap-3">
                                        <div className="flex items-center gap-2 flex-1 min-w-0">
                                            ...
                                            <div className="flex-shrink-0">
                                                <Badge
                                                    variant="secondary"
                                                    className="bg-purple-100 text-purple-800 border-purple-200 font-semibold text-sm px-2 py-1 shadow-sm"
                                                >
                                                    {transfer.amount}
                                                </Badge>
                                            </div>
                                        ...
                                        <div className="flex items-center gap-0.5 opacity-70 group-hover:opacity-100 transition-opacity">
                                            <Button
                                                ...
                                                className="h-6 w-6 p-0 hover:bg-purple-100 hover:text-purple-700 transition-colors"
                                            >
                                            ...
                                            <AlertDialog>
                                                <AlertDialogTrigger asChild>
                                                    <Button
                                                        variant="ghost"
                                                        size="sm"
                                                        className="h-6 w-6 p-0 text-gray-900 hover:text-destructive hover:bg-destructive/10 transition-colors"
                                                        disabled={
                                                            deletingTransferId ===
                                                            transfer.id
                                                        }
                ...
                <Card className="p-4 bg-green-50 border-green-200 mt-4">
                    <div className="space-y-2">
                        ...
                        <div className="text-sm text-green-700">
                            <div className="mb-1">
                                <strong>{selectedEthicsCourse}</strong>{" "}
                                fulfills the ethics requirement.
                            </div>
                ...
                <Card className="p-4 bg-blue-50 border-blue-200 mt-4">
                    <div className="space-y-2">
                        ...
                        <div className="text-sm text-blue-700">
                            <div className="mb-1">
                                <strong>{selectedAnchorCourse}</strong> is
                                your anchor course for INFO 5920.
                            </div>
                            <div className="text-blue-600">
                                This course has been moved to{" "}
                                <strong>Jacobs Programmatic Core</strong>{" "}
                                and will count as your anchor course for the
