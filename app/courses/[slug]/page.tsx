...
export default function CourseDetailPage() {
  ...
  useEffect(() => {
    if (course?.reviews) {
      ...
      if (selectedTerm !== "all") {
        filtered = filtered.filter((review) => review.term === selectedTerm);
      }
  ...
  const handleDeleteReview = async (reviewId: string) => {
    try {
      ...
      if (course) {
        const updatedReviews = course.reviews.filter(
          ...
          <Tabs defaultValue="reviews" className="w-full">
            ...
            <TabsContent value="reviews" className="pt-6">
              <div className="space-y-6">
                ...
                {course.professors && course.professors.length > 1 && (
                  <div className="flex items-center gap-2">
                    <Select
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        {course.professors
                          .filter((prof) => prof.name !== "Unknown Professor")
                          .map((prof) => (
                ...
                {filteredReviews.length > 0 || course.reviews.length > 0 ? (
                  <div className="space-y-6">
