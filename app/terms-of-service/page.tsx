      ...
      <div className="container max-w-4xl pt-24 pb-8 px-4 mx-auto">
        ...
        <div className="prose prose-gray prose-invert">
          ...
          <section className="mb-6">
            ...
            <p>
              By accessing and using Cornell Tech Hub ("the Platform"), you
          ...
          <section className="mb-6">
            ...
            <p>
              The Platform is intended for use by Cornell Tech students,
              faculty, and staff. By using the Platform, you represent and
              warrant that you are a member of the Cornell Tech community.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-6">
              ...
              <li>
                Use the Platform in compliance with Cornell Tech's policies
              </li>
              <li>Respect the intellectual property rights of others</li>
              <li>
                Not engage in any activity that may harm the Platform or other
                users
              </li>
            </ul>
          </section>
          ...
          <section className="mb-6">
            ...
            <p>
              ...
              are owned by Cornell Tech Hub and are protected by international
          ...
          <section className="mb-6">
            ...
            <p>
              Cornell Tech Hub shall not be liable for any indirect, incidental,
