  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    if (e.key === "Enter" || e.key === ",") {
      ...
      if (cleanTag) {
        ...
        toast({
          title: "Invalid Tag",
          description: "Tags must be single words with no special characters",
          variant: "destructive",
        });
      }
    }
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          title: "Error",
          description:
            result.error || "Failed to create thread. Please try again.",
          variant: "destructive",
        });
      }
    } catch (error) {
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="text-muted-foreground text-lg mt-2">
                  Start a new discussion or ask a question to the Cornell Tech
                  community
                </p>
              </div>
            </div>
