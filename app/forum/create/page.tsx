          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col gap-4">
              ...
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Create New Thread</h1>
                <p className="text-muted-foreground md:text-xl">
                  Start a new discussion or ask a question to the Cornell Tech community
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="container px-4 py-6 md:px-6">
          <Card className="mx-auto max-w-2xl">
            <CardHeader>
              ...
              <CardDescription>Please provide details about your discussion topic or question</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Add up to 5 tags to help categorize your thread</p>
                {tags.length > 0 && (
